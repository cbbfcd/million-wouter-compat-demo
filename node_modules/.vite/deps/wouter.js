...
// node_modules/.pnpm/wouter@2.8.0-alpha.2/node_modules/wouter/use-location.js
...
var use_location_default = ({ base = "" } = {}) => {
  ...
  const navigate = useCallback((to, { replace = false } = {}) => history[replace ? eventReplaceState : eventPushState](null, "", to[0] === "~" ? to.slice(1) : base + to), [base]);
...
// node_modules/.pnpm/wouter@2.8.0-alpha.2/node_modules/wouter/matcher.js
...
// node_modules/.pnpm/wouter@2.8.0-alpha.2/node_modules/wouter/index.js
...
var Switch = ({ children, location: location2 }) => {
  ...
  for (const element of flattenChildren(children)) {
    let match = 0;
    if (isValidElement(element) && (match = element.props.path ? matcher(element.props.path, location2 || originalLocation) : [true, {}])[0])
